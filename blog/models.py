...
from django.contrib.auth.models import User    #该项目中的用户模型直接使用Django自带的User模型
...
class Post(models.Model):
    ...
    stauts=models.PositiveIntegerField(default=STATUS_NORMAL,choices=STATUS_ITEMS,verbose_name="状态")
